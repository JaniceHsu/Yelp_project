...
def test_classifiers(train_docs, train_target, test_docs, test_targets,  min_docs, K, K2):
    """
    ...
    X_train_counts, X_train_tfidf, X_test_counts, X_test_tfidf = extract_text_features(train_docs,  test_docs, min_docs)
